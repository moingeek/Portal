		...
		<div class="row">
			...
			<div class="col-lg-3">			
				<div class="card" style="width: 20rem;">
 					<img class="card-img-top" src="../../students/subjects/te/img/cn.png"  width="200" height="200" alt="Computer Networks">
			...
			<div class="col-lg-3">			
				<div class="card" style="width: 20rem;">
 					<img class="card-img-top" src="../../students/subjects/te/img/mp.png"  width="200" height="200" alt="Computer Networks">
  					<div class="card-block">
			...
			<div class="col-lg-3">			
				<div class="card" style="width: 20rem;">
 					<img class="card-img-top" src="../../students/subjects/te/img/wtl.png"  width="200" height="200" alt="Computer Networks">
  					<div class="card-block">
			...
			<div class="col-lg-3">			
				<div class="card" style="width: 20rem;">
 					<img class="card-img-top" src="../../students/subjects/te/img/os.png"  width="200" height="200" alt="Computer Networks">
  					<div class="card-block">
			...
			<div class="col-lg-3">			
				<div class="card" style="width: 20rem;">
 					<img class="card-img-top" src="../../students/subjects/te/img/soad.png"  width="200" height="200" alt="Computer Networks">
  					<div class="card-block">
